        ...
        <div class="container-fluid p-0 mb-5">
            <div class="owl-carousel header-carousel position-relative">
                <div class="owl-carousel-item position-relative">
                    <div style="background-image: url('img/slid.jpg');width:100%; height:600px; background-position: top;background-size: cover; "></div>
                ...
                <div class="owl-carousel-item position-relative">
                    <div style="background-image: url('img/slid2.jpg');width:100%; height:600px; background-position: bottom;background-size: cover;"></div>                    <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center" style="background: rgba(0, 0, 0, .2);">
                        <div class="container">
                            <div class="row justify-content-start">
                                <div class="col-10 col-lg-8">
                    ...
                    <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="facility-item">
                            ...
                            <div class="facility-text bg-primary">
                                ...
                                <p class="mb-0">All the necessary tools to develop the relationship between them and parents and students</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="facility-item">
                            ...
                            <div class="facility-text bg-success">
                                ...
                                <p class="mb-0">Providing the necessary tools to upgrade the teacher and carry out his duties to the fullest</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.7s">
                        <div class="facility-item">
                            ...
                            <div class="facility-text bg-info">
                                ...
                                <p class="mb-0">Achieving the best educational results and the participation of parents and the school in raising the child</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                            <div class="h-100 d-flex flex-column justify-content-center p-5">
                                ...
                                <p class="mb-4">
                                    Add to your school environment a set of wonderful tools and additional services that we will help you provide
                                </p>
