...
<head>
    ...
    <!-- Favicon-->
    <link rel="icon" href="{{asset('dashbord/favicon.ico')}}" type="image/x-icon">
...
<body class="login-page">
    <div class="login-box">
        ...
        <div class="card">
            <div class="body">
                <form id="sign_in" action="{{route('admin.login_v')}}" method="POST">
                    @csrf
    ...
    <script src="{{asset('dashbord/plugins/jquery-validation/jquery.validate.js')}}"></script>

    <!-- Custom Js -->
    <script src="{{asset('dashbord/js/admin.js')}}"></script>
    <script src="{{asset('dashbord/js/pages/examples/sign-in.js')}}"></script>
</body>
